...
namespace prompt_planner
{
  ...
  public:
    PromptPlanner(const rclcpp::NodeOptions &options = rclcpp::NodeOptions())
        : Node("prompt_planner", options), loop_hz_(1.0), frame_id_("agent"), transaction_limit_(10)
          // , prompt_history_()
          ,
          prompt_provider_loader_("prompt_provider_plugins", "prompt_provider::PromptProviderBase"), scheme_loader_("prompt_schemes", "prompt_schemes::SchemeBase")
    {
      // loop rate
